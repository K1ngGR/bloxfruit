-- Phiên bản tối ưu hóa Cải thiện hiệu suất và chất lượng
-- Lưu trữ tất cả các dịch vụ khi bắt đầu để có hiệu suất tốt hơn
...
local function NotificacaoNightMystic(titulo, mensagem)
    local success = pcall(function()
        ...
        local LogoID = "rbxassetid://97700323619204"
...
NotificacaoNightMystic("King Hub", "Loading Script thành công !")

-- ===========================================
-- HỆ THỐNG LƯU (Tối ưu hóa)
-- ===========================================
local HttpService = Services.HttpService
local FolderName = "King Hub" -- Thay đổi được
...
-- Sáng hoàn toàn (ánh sáng được tối ưu hóa)
...
-- ===========================================
-- BIẾN TOÀN CẦU (Được lưu trong bộ nhớ đệm & có tổ chức)
-- ===========================================
do
...
-- CHIỀU CAO MOB CÓ THỂ ĐIỀU CHỈNH ĐƠN
...
QuestNeta = function()
	...
	local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/K1ngGR/main/refs/heads/main/main-KingHub.lua"))():MakeWindow({
    Title = "King Hub",
    SubTitle = "Blox Fruit",
    SaveFolder = "KingHub.json"
})
-- Criar ScreenGui
local screenGui = Instance.new("ScreenGui")
...
imageButton.Image = "rbxassetid://97700323619204"
...
Shop:AddSection("Cửa hàng kỹ năng")
Shop:AddButton({
    Name = "Nhảy cao [ $10,000 Beli ]",
    Callback = function()
...
Shop:AddSection("Cửa hàng linh tinh")
Shop:AddButton({
    Name = "Mua Reset Chỉ Số (2500F)",
    Callback = function()
        local Remote = game:GetService("ReplicatedStorage").Remotes.CommF_
...
local MobCakePrince = Status:AddParagraph({
    Title = "Đánh Mod Triệu hồi Hoàng tử bánh ngọt",
    Desc = ""
})
spawn(function()
    while wait() do
        pcall(function()
            ...
            elseif len == 86 then
                ...
                MobCakePrince:SetDesc("Hoàng tử bánh ngọt : ✅️")
            end
        end)
    end
end)
local TyrantStatus = Status:AddParagraph({
    Title = "Bạo chúa bầu trời",
    Desc = "Status: "
})
spawn(function()
    pcall(function()
    ...
    pcall(function()
        while wait() do
            ...
            elseif rs:InvokeServer("LegendarySwordDealer", "3") then
                ...
                LegendarySword:SetDesc("Không tìm thấy NPC bán kiếm huyền thoại")
            end
        end
    end)
end)
...
spawn(function()
    pcall(function()
        while wait() do
            ...
            Bone:SetDesc("Bạn có : " .. tostring(bones) .. " Xương")
        end
    end)
end)
Status:AddTextBox({
...
Status:AddButton({
    Name = "Tham gia SV đã  nhập ID",
    Callback = function()
        game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId,getgenv().Job,game.Players.LocalPlayer)
    end
})
Status:AddButton({
    Name = "Sao chép ID SV đang chơi",
    Callback = function()
...
if World3 then
Farm:AddToggle({
    Name = "Tự động đánh hải tặc trên biển",
    Description = "",
    -- 1. Carrega se estava ligado ou desligado ao abrir o script
...
Setting:AddSection({"Lưu thủ công"})

Setting:AddButton({
    Name = "Lưu cài đặt ngay",
    Description = "Tạo bản sao lưu thủ công cho các tùy chọn hiện tại của bạn",
    Callback = function()
        ...
        if SaveSettings then
            ...
            warn("Lỗi: Không tìm thấy chức năng lưu cài đặt !")
        end
    end
})

Setting:AddButton({
    Name = "Đặt lại cài đặt",
    Description = "Xóa file save và trở về mặc định",
    Callback = function()
        ...
        if isfile and isfile(FullPath) then
            ...
            game.StarterGui:SetCore("SendNotification", {
                Title = "",
                Text = "Thiết lập lại cài đặt! Chạy lại script.",
                Duration = 5
            })
        else
            game.StarterGui:SetCore("SendNotification", {
                Title = "",
                Text = "Không tìm thấy tập tin lưu để xóa.",
                Duration = 3
            })
        end
    end
})
Setting:AddSection({"Cài đặt cày"})
Setting:AddButton({
    Name = "Dừng",
    Description = "",
    Callback = function()
...
Setting:AddToggle({
	Name = "Chế độ an toàn",
	Description = "hãy bật lên để đảm bảo an toàn khi máu còn ít",
	-- 1. Carrega o estado salvo
...
Others:AddToggle({
    ...
    Description = "Tự động tạo ra mồi đã chọn",
...
Others:AddToggle({
    Name = "Tự động câu",
    Description = "Tự Click và kéo thanh tự động",
    -- Carrega se estava ligado
...
-- 8. AUTO SPAM SKILL Z
Others:AddToggle({
    Name = "Tự động dùng kỹ năng",
    Description = "Tự động dùng kỹ năng Z của công cụ được trang bị",
    -- Carrega se estava ligado
...
Others:AddSection({"Nhiệm vụ"})
 Others:AddToggle({
    Name = "Tự động luyện Haki Quan Sát",
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
Others:AddSection({"Song kiếm Oden"});
local r = Others:AddParagraph({ Title = "Elites ", Content = "" });
spawn(function()
	while wait(Sec) do
		pcall(function()
			r:SetDesc("Elite Đã Kill :  " .. replicated.Remotes.CommF_:InvokeServer("EliteHunter", "Progress"));
		end);
	end;
end);
Others:AddToggle({
...
spawn(function()
 ...
 Others:AddToggle({
    Name = "Dừng lại khi có được God's Chalice",
    Description = "",
...
Others:AddSection({"Haki"});

 Others:AddToggle({
    Name = "Dịch chuyển đến NPC bán Haki",
    Description = "",
    -- 1. Carrega se estava ligado ou desligado ao abrir o script
...
if World3 then
 Others:AddToggle({
    Name = "Tự động nhiệm vụ Haki 7 Màu",
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
spawn(function()
 ...
 Others:AddToggle({
    Name = "Chấp nhận bỏ qua nhiệm vụ [Rủi ro]",
    Description = "",
...
local z5 = {
    ...
    Event:AddToggle({
        Name = "Tự động Sự kiện biển",
        Description = "Tự Động Mua Thuyền & Di Chuyển",
        Default = false,
        Callback = function(I)
            _G.SailBoats = I;
        end,
...
Event:AddToggle({
        ...
        Description = "Kích hoạt tốc độ thuyền tùy chỉnh",
        Default = false,
        Callback = function(Value)
            _G.SpeedBoat = Value
        end
...
Event:AddSection({"Chọn Đánh Sự Kiện Biển"})
    Event:AddToggle({
...
if World2 then
  Event:AddSection({"Vào Sea 3 để có thêm lựa chọn."})
end
if World1 then
  Event:AddSection({"Đến Biển 3 hoặc Biển 2 để xem thêm"})
end
...
Event:AddButton({
	Name = "Mua Chips Leviathan",
	Description = "Mua Chips để tìm Leviathan",
	Callback = function()
		replicated.Remotes.CommF_:InvokeServer("InfoLeviathan", "2");
	end
});
Event:AddToggle({
    Name = "Dịch chuyển đến đảo Leviathan",
    Description = "Bật dịch chuyển tức thời đến chiều không gian đóng băng và khởi động cổng Leviathan",
...
Event:AddSection({"Đảo Kitsune / Sự Kiện"});
Event:AddToggle({
    Name = "Tự động tìm đảo Kitsune",
    Description = "Bật tìm & bay đến đảo kitsune",
...
Event:AddToggle({
	Name = "Tự động dịch chuyển đến đền thờ đã kích hoạt",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.tweenShrine = I;
...
Event:AddButton({ Name = "Đổi vật phẩm Azure", Description = "", Callback = function()
		(replicated.Modules.Net:FindFirstChild("RF/KitsuneStatuePray")):InvokeServer();
	end });
Event:AddButton({ Name = "Nói chuyện với tượng Kitsune", Description = "", Callback = function()
		(replicated.Modules.Net:FindFirstChild("RE/TouchKitsuneStatue")):FireServer();
	end });
	Event:AddSection({"Đảo Bí Ẩn / Trăng Tròn"});
Event:AddToggle({
...
Event:AddToggle({
    ...
    Description = "Bay đến điểm cao nhất của đảo bí ẩn (Lý tưởng để ngắm Mặt Trăng)",
    -- 1. Carrega o estado salvo
...
Event:AddToggle({
    ...
    Description = "Thu thập trang bị trong đảo (Blue Gear)",
...
Event:AddToggle({
	Name = "Tự động bay đến NPC bán trái cây cao cấp",
    Description = "",
    -- 1. Carrega se o teleporte estava ativo
...
Event:AddToggle({
	Name = "Tự động nhặt rương ở đảo bí ẩn",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.FarmChestM = I;
...
Event:AddToggle({
    ...
    Description = "Tự động cày nguyên liệu và chế tạo nam châm núi lửa và dừng khi có 1 nam châm núi lửa",
    Default = false,
    Callback = function(I)
        _G.CraftVM = I;
    end,
...
Event:AddSection({"Đảo thời tiền sử"});
Event:AddToggle({
    Name = "Tự động tìm đảo thời tiền sử",
    Description = "",
...
Event:AddToggle({
    Name = "Tự động Sự kiện Đảo thời tiền sử",
    Description = "",
    -- 1. Carrega o estado salvo
...
-- 3. TOGGLE: Auto Reset
Event:AddToggle({
    Name = "Tự động Reset khi núi lửa hoàn thành",
    Description = "",
...
if World2 or World3 then
Event:AddSection({"Cài đặt kỹ năng (Võ)"})
-- [[ TOGGLES MELEE ]]
Event:AddToggle({
    Name = "Skill Z",
...
Race:AddSection({"Race nâng cấp v4 chỉ có ở Sea 3"});
end
if World1 then
Race:AddSection({"chỉ ở Biển 2 hoặc 3 để nâng cấp lên Race"});
end
if World3 then
Race:AddSection({"Nhiệm vụ Tộc / Tộc V4"});
local K5 = Race:AddParagraph({ Title = " Trạng thái tộc V4 ", Content = "" });
spawn(function()
	pcall(function()
		while wait(.2) do
			K5:SetDesc(" Tộc - V4  :" .. (" " .. plr.Data.Race.C.Value));
		end;
	end);
end);
Race:AddToggle({
	Name = "Tự động nhìn vào mặt trăng",
	Description = "",
	Default = false,
	Callback = function(I)
		LookM = I;
...
Race:AddToggle({
	Name = "Tự động UP V4",
	Description = "Tự động cày bật v4 + tự động mua gear",
	Default = false,
	Callback = function(I)
		_G.AcientOne = I;
	end,
...
Race:AddButton({ Name = "Dịch chuyển đến Ngôi đền thời gian", Description = "", Callback = function()
...
Race:AddToggle({
	Name = "Tự động hoàn thành UP Tộc",
	Description = "",
	Default = false,
	Callback = function(I)
...
Race:AddToggle({
	Name = "Tự động kill người chơi đang up tộc",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.Defeating = I;
...
Dojo:AddToggle({
	...
	Description = "bật nhiệm vụ lấy đai dojo từ trắng sang đen",
	Default = false,
	Callback = function(I)
		_G.Dojoo = I;
	end,
...
Dojo:AddToggle({
	...
	Description = "Tự động cày blaze ember + tự động thu thập blaze ember",
	Default = false,
	Callback = function(I)
		_G.FarmBlazeEM = I;
	end,
...
Dojo:AddToggle({
	Name = "Tự động UP Tộc Draco (V1)",
	Description = "bật sự kiện thời tiền sử tự động nhiệm vụ 1 + thu thập trứng rồng",
	Default = false,
	Callback = function(I)
		_G.DragoV1 = I;
	end,
...
Dojo:AddToggle({
	Name = "Tự động UP Tộc Draco (V2)",
	Description = "bật tính năng tự động tiêu diệt Cướp Rừng & Thu thập hoa lửa",
	Default = false,
	Callback = function(I)
...
Dojo:AddToggle({
	Name = "Tự động UP Tộc Draco (V3)",
	Description = "bật sự kiện biển tiêu diệt terror shark",
	Default = false,
	Callback = function(I)
		_G.DragoV3 = I;
	end,
...
Dojo:AddToggle({
	Name = "Tự động Up Tộc Draco [Beta]",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.Relic123 = I;
...
Dojo:AddToggle({
	Name = "Tự động luyện V4 Tộc Draco",
	Description = "bật luyện v4 Drago + tự động nâng cấp gear",
	Default = false,
	Callback = function(I)
		_G.TrainDrago = I;
	end,
...
Dojo:AddToggle({
	Name = "Nâng cấp Dragon Talon NPCs Uzoth",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.DT_Uzoth = I;
...
-- UI E TOGGLES
Esp:AddSection({"Esp / Phông Chữ / Chỉ Số"});

Esp:AddToggle({Name = "Esp Berri", Default = false, Callback = function(I) 
    BerryEsp = I; 
...
Esp:AddToggle({Name = "Esp Trái Ác Quỉ", Default = false, Callback = function(I)
    DevilFruitESP = I
...
if World2 then
    ...
    Esp:AddToggle({Name = "Esp NPC bán Kiếm Legendary", Default = false, Callback = function(I)
        LegenS = I
...
if World2 or World3 then
    Esp:AddToggle({Name = "Esp NPC bán Haki màu", Default = false, Callback = function(I)
        ColorEsp = I
...
if World3 then
    ...
    Esp:AddToggle({Name = "Esp NPC bán trái ở đảo bí ẩn", Default = false, Callback = function(I)
        advanEsp = I
...
Player:AddSection({"PvP, Aimbot, Tốc  độ"})
...
Player:AddSection({"Tốc Độ/Nhảy Cao"});
local RunService = game:GetService("RunService")
local Players = game:GetService("Players")
...
Player:AddToggle({
	Name  = "Đặt tốc độ chạy",
    Description = "Bật Tốc độ chạy tùy chỉnh",
    Default = false,
    Callback = function(Value)
        SpeedEnabled = Value
        applyStats()
...
Player:AddToggle({
	Name  = "Đặt Nhảy Cao",
    Description = "Bật Nhảy cao tùy chỉnh",
    Default = false,
    Callback = function(Value)
        JumpEnabled = Value
        applyStats()
...
Player:AddSection({"Cài đặt người chơi / Khác"});
Player:AddToggle({
	Name = "Tộc Mink V3 [ ꝏ ]",
	Description = "Bật Tộc mink v3 không giới hạn",
	Default = false,
	Callback = function(I)
		InfAblities = I;
	end,
...
Player:AddToggle({
	Name = "Năng lượng [ ꝏ ]",
	Description = "bật để tạo ra năng lượng vô tận",
	Default = false,
	Callback = function(I)
		infEnergy = I;
		if I then
...
Player:AddToggle({
	Name = "Tốc Biến [ ꝏ ]",
	Description = "bật tốc biến không giới hạn",
	Default = false,
	Callback = function(I)
		_G.InfSoru = I;
		if I then
...
Player:AddToggle({
	Name = "Haki Quan Sát [ ꝏ ]",
	Description = "bật haki quan sát vô cực",
	Default = false,
	Callback = function(I)
...
Player:AddSection({"Cài đặt PvP / Aimbot"});
Player:AddToggle({
	Name = "Bỏ qua các đội giống nhau",
	Description = "bật để bỏ qua chứ không phải aimbot cùng một đội",
	Default = false,
	Callback = function(I)
		_G.NoAimTeam = I;
	end,
...
Teleport:AddSection({"Thế giới"});
Teleport:AddButton({ Name = "Dịch chuyển Biển 1", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("TravelMain");
	end });
Teleport:AddButton({ Name = "Dịch chuyển Biển 2", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("TravelDressrosa");
	end });
Teleport:AddButton({ Name = "Dịch chuyển Biển 3", Description = "", Callback = function()
...
Teleport:AddButton({ Name = "Dịch chuyển đến cổng", Description = "", Callback = function()
...
Teleport:AddToggle({
	Name = "Tự động tới NPC",
	Description = "Tự động dịch chuyển đến vị trí Npcs",
	Default = false,
	Callback = function(I)
		_G.TPNpc = I;
	end,
...
Get:AddToggle({
	Name = "Tự động cày tất cả kiếm 600 thông thạo",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.FarmMastery_S = I
...
if World3 then
Get:AddSection({"Song kiếm Oden"});
local I5 = Get:AddParagraph({ Title = " Số nhiệm vụ song kiếm ", Content = "Số nhiệm vụ :" });
spawn(function()
	while wait(.2) do
		if QuestYama_1 == true then
			I5:SetDesc(" Số nhiệm vụ : yama quest 1");
		elseif QuestYama_2 == true then
			I5:SetDesc(" Số nhiệm vụ : yama quest 2");
		elseif QuestYama_3 == true then
			I5:SetDesc(" Số nhiệm vụ : yama quest 3");
		elseif QuestTushita_1 == true then
			I5:SetDesc(" Số nhiệm vụ : tushita quest 1");
		elseif QuestTushita_2 == true then
			I5:SetDesc(" Số nhiệm vụ : tushita quest 2");
		elseif QuestTushita_1 == true then
			I5:SetDesc(" Số nhiệm vụ : tushita quest 2");
		elseif GetWP("Cursed Dual Katana") then
			I5:SetDesc(" Số nhiệm vụ : CDK Xong !");
		end;
	end;
end);
Get:AddToggle({
 Name = "Tự động nhận CDK [Nhiệm vụ cuối cùng]",
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
Get:AddToggle({
 Name = "Dịch chuyển đến NPC bán kiếm huyền thoại",
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
    Default = GetSetting("TpLegendarySword_Save", false),
    Callback = function(I)
...
Get:AddToggle({
 Name = "Tự động lấy kiếm Bisento V2",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.Greybeard = I;
...
Get:AddToggle({
 Name = "Tự động lấy Áo khoác biển",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.MarinesCoat = I;
...
Get:AddToggle({
 Name = "Tự động lấy Áo khoác thiên nga",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.SwanCoat = I;
...
Get:AddToggle({
 Name = "Tự động lấy Cây đinh ba rồng",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AutoTridentW2 = I;
...
Get:AddToggle({
 Name = "Tự động lấy Lưỡi kiếm nửa đêm",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AutoEcBoss = I;
...
Get:AddToggle({
 Name = "Tự động lấy Áo Choàng Râu Đen",
	Description = "",
	Default = false,
	Callback = function(I)
...
Fruit:AddToggle({
	Name = "Mua Chip",
	Description = "Tự động lấy trái dưới 1Tr",
	Default = false,
	Callback = function(state)
...
Fruit:AddSection({"Cày Raid"});

Fruit:AddToggle({
	Name  = "Tự động bắt đầu Raid",
    Description = "Bắt đầu một cuộc tấn công tự động và bảo vệ 10 giây sau khi xác minh",
    Default = false,
    Callback = function(I)
        _G.Auto_StartRaid = I;
    end,
...
Fruit:AddButton({ Name = "Mua Trái Stock", Description = "", Callback = function()
...
Fruit:AddButton({ Name = "Mua Trái Stock Đảo Bí Ẩn", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("PurchaseRawFruit", SelectF_Adv);
	end });
Fruit:AddToggle({
	Name  = "Tự động Random Trái",
    Description = "Trái ác quỷ ngẫu nhiên tự động",
...
Get:AddToggle({
	...
	Description = "Tự động thả trái ác quỷ",
	Default = false,
	Callback = function(I)
		_G.DropFruit = I;
	end,
...
Fruit:AddToggle({
	Name  = "Tự động lưu trái",
    Description = "Tự động lưu trái ác quỷ vào túi",
...
Fruit:AddToggle({
    ...
    Description = "Tự động bay đến để nhận trái ác quỷ",
    -- 1. Carrega o estado salvo
...
Fruit:AddToggle({
	Name  = "Tự động thu thập trái cây",
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
Setting:AddSection({"Đội"});
Setting:AddButton({ Name = "Đổi qua Hải Tặc", Description = "", Callback = function()
		Pirates();
	end });
Setting:AddButton({ Name = "Đổi qua Hải Quân", Description = "", Callback = function()
		Marines();
	end });
...
Setting:AddButton({ Name = "Đổi Vị Trí Haki", Description = "", Callback = function()
...
Setting:AddButton({ Name = "Tăng cường khung hình / giây", Description = "", Callback = function()
		LowCpu();
	end });
...
NotificacaoNightMystic("", "✅ Tất cả các hệ thống được tải !")
